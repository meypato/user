...
class BuildingRoomDetailScreen extends StatefulWidget {
  final String buildingId;
  final String roomId;

  const BuildingRoomDetailScreen({
    super.key,
  ...
  @override
  State<BuildingRoomDetailScreen> createState() => _BuildingRoomDetailScreenState();
}

class _BuildingRoomDetailScreenState extends State<BuildingRoomDetailScreen> {
  ...
  Future<void> _loadRentDetail() async {
    try {
      ...
      final roomDetail = await RoomService.getRoomDetail(widget.roomId);
    ...
    return SliverAppBar(
      ...
      leading: Container(
        ...
        child: IconButton(
          ...
          onPressed: () => context.go('/building/${widget.buildingId}'),
        ),
      ),
      actions: [
        Container(
